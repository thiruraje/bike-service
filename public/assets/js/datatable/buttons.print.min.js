(function(f) { "function" === typeof define && define.amd ? define(["jquery", "datatables.net", "datatables.net-buttons"], function(e) { return f(e, window, document) }) : "object" === typeof exports ? module.exports = function(e, c) { e || (e = window); if (!c || !c.fn.dataTable) c = require("datatables.net")(e, c).$;
    ...
    i.ext.buttons.print = {
        ...
        text: function(b) { return b.i18n("buttons.print", "<i class='fa fa-print'></i> Print") },
        action: function(b, c, i, d) {
            ...
            f("style, link").each(function() { var c = j,
                ...
                j = c + b.outerHTML });
            try { g.document.head.innerHTML = j } catch (n) { f(g.document.head).html(j) } g.document.body.innerHTML = "<h1>" + a + "</h1><div>" +
