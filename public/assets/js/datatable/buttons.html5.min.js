(function(g) { "function" === typeof define && define.amd ? define(["jquery", "datatables.net", "datatables.net-buttons"], function(i) { return g(i, window, document) }) : "object" === typeof exports ? module.exports = function(i, j, t, u) { i || (i = window); if (!j || !j.fn.dataTable) j = require("datatables.net")(i, j).$;
        ...
        g.each(b, function(b, c) {
            if (g.isPlainObject(c)) { var f = a.folder(b);
                ...
                if (v) { var f = c.childNodes[0],
                        e, h, l = []; for (e = f.attributes.length - 1; 0 <= e; e--) { h = f.attributes[e].nodeName; var n = f.attributes[e].nodeValue; - 1 !== h.indexOf(":") && (l.push({ name: h, value: n }), f.removeAttribute(h)) } e = 0; for (h = l.length; e < h; e++) n = c.createAttribute(l[e].name.replace(":", "_dt_b_namespace_token_")), n.value = l[e].value, f.setAttributeNode(n) } f = y.serializeToString(c);
    ...
    r.ext.buttons.excelHtml5 = {
        ...
        text: function(a) { return a.i18n("buttons.excel", "<i class='fa fa-file-excel-o'></i> Excel") },
        action: function(a, b,
            d, c) {
            var f = 0,
    ...
    r.ext.buttons.pdfHtml5 = {
        ...
        text: function(a) { return a.i18n("buttons.pdf", "<i class='fa fa-file-pdf-o'></i> PDF") },
        action: function(a, b, d, c) {
            K(c);
